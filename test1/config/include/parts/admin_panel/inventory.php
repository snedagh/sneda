    ...
    <div class="row h-100">
        <div class="col-sm-2 h-100">
            ...
            <article class="p-1">
                ...
                <!-- INVENTORY -->
                <button onclick="set_session('tool=inventory,todo=new_asset,stage=asset_type,view=all','<?php echo $token ?>')" class="btn <?php if($todo === 'new_asset'){echo 'r_nav_active';} else {echo 'r_nav';} ?> text-light text-left w-100" data-target="#inventory_collapse">
                    <span class="fa fa-boxes-stacked"></span> New Device
                </button>

                <button onclick="set_session('tool=inventory,todo=view_workstation,view=all','<?php echo $token ?>')" class="btn <?php if($todo === 'view_workstation'){echo 'r_nav_active';} else {echo 'r_nav';} ?> text-light text-left w-100" data-target="#inventory_collapse">
                    <span class="fa fa-boxes-stacked"></span> Work Stations
                </button>

                <button onclick="set_session('tool=inventory,todo=view_none_workstation,view=all','<?php echo $token ?>')" class="btn <?php if($todo === 'view_none_workstation'){echo 'r_nav_active';} else {echo 'r_nav';} ?> text-light text-left w-100" data-target="#inventory_collapse">
                    <span class="fa fa-boxes-stacked"></span> Other Devices
                </button>
        ...
        <div class="col-sm-10 h-100">
            ...
            <div class="w-100 h-100 d-flex flex-wrap overflow-auto align-content-center justify-content-center bg-light">
                    ...
                    <div class="card shadow w-25 p-2">
                        ...
                        <div class="card-body p-2">
                            <select name="" id="asset_type" class="form-control rounded-0">
                                ...
                                <option value="none_computing">None Computing</option>
                ...
                <?php if($stage === 'none_computing'): //todo submit new workstation form ?>

                    <form id="regular_form" method="post" action="config/proc/form_process.php" class="card h-100 shadow w-100">
                        <input type="hidden" name="function" value="new_none_computing">
                        <input type="hidden" name="token" value="<?php echo session_id() ?>">
                        <div class="card-header bg-track-head">
                            <strong class="card-title">New None Computing Device</strong>
                            <div class="float-right d-flex flex-wrap justify-content-end align-content-center h-100">
                                <button onclick="set_session('tool=inventory,todo=view_workstation,view=all','<?php echo $token ?>')" type="button" class="btn btn-sm btn-danger mx-1">Cancel</button>
                                <button type="reset" class="btn btn-sm btn-warning mx-1">Reset</button>
                                <button type="submit" class="btn btn-sm btn-light mx-1">Save</button>
                        ...
                        <div class="card-body bg-modal  overflow-auto py-2">
                            <div class="w-75 mx-auto p-0 containe h-100 overflow-auto">
                                <div class="row no-gutters">
                                    <div class="col-sm-12 px-2">
                                        <p class="font-weight-bolder m-0"> Core</p>
                                    </div>
                                    <!-- Owner -->
                                    <div class="col-sm-6 p-2 input-group-sm">
                                        <input autofocus type="text" placeholder="Description" name="description" id="description" class="form-control rounded-0" required autocomplete="off">
                                    </div>


                                    <!-- Location -->
                                    <div class="col-sm-3 p-2 input-group-sm">
                                        <select required name="branch" id="branch" class="form-control rounded-0">
                                            <option disabled selected >Location</option>
                                            <?php
                                            $cps = $pdo->query('select * from branch');
                                            while ($cpu = $cps->fetch(PDO::FETCH_ASSOC))
                                            {
                                                $cp_id = $cpu['loc_id'];
                                                $cp_desc = $cpu['description'];
                                                echo "<option value='$cp_id'>$cp_desc</option>" ;
                                            }
                                    ...
                                    <div class="col-sm-12 mt-5 px-2">
                                        <p class="font-weight-bolder m-0"> Details</p>
                                    </div>

                                    <!-- Manufacturer -->
                                    <div class="col-sm-4 p-2 input-group-sm">

                                        <label for="cpu">Manufacturer</label>
                                        <input  type="text" placeholder="Manufacturer" name="manufacturer" id="manufacturer" class="form-control rounded-0" required autocomplete="off">
                                    ...
                                    <div class="col-sm-4 p-2 input-group-sm">
                                        ...
                                        <label for="cpu">Model</label>
                                        <input type="text" placeholder="Model" name="model" id="model" class="form-control rounded-0" required autocomplete="off">

                                    </div>

                                    <div class="col-sm-12 mt-5 px-2">
                                        <p class="font-weight-bolder m-0"> Description</p>
                                    </div>
                                    <div class="col-sm-12 p-2">
                                        <textarea required name="details" rows="10" class="form-control rounded-0 cust_shadow"></textarea>
                                    </div>
                    ...
                    <div class="w-75 h-100 mx-auto p-2">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-striped">
                                ...
                                <tr>
                                <tr>
                                    <td>Email</td><td><a href="mailto:<?php echo $dev_info['email'] ?>"><?php echo $dev_info['email'] ?></a></td>
                                <tr>
                                <tr>
                        ...
                        <div class="w-75 h-100 mx-auto p-2">
                            ...
                            <form method="post" action="config/proc/form_process.php" id="regular_form" class="table-responsive">
                                ...
                                <table class="table table-sm table-bordered table-striped">
                                    ...
                                    <tr>
                                        <td>Email</td>
                                        <td><input class="form-control form-control-sm" type="email" required value="<?php echo $dev_info['email'] ?>" name="email"></td>
                                    <tr>
                                    <tr>
            ...
            <?php endif; ?>
                ...
                <?php if($todo === 'view_none_workstation'):
                $view = $_SESSION['view'];
                if($view === 'all'){
                    ?>
                    ...
                    <div class="w-100 h-100 overflow-hidden p-1 flex-wrap">
                        ...
                        <header>
                            <div class="w-100 h-100 d-flex justify-content-end align-content-center">
                                <div class="h-100 w-20 d-flex flex-wrap align-content-center justify-content-end">
                                    <span onclick="set_session('todo=new_asset,stage=none_computing','<?php echo $token ?>')" title="New Workstation" class="pointer fa fa-add text-info m-1"></span>
                                    <span title="Export" class="pointer fa fa-file-export text-danger m-1"></span>
                                </div>
                            </div>
                        </header>
                        ...
                        <article class="overflow-auto">
                            <div class="w-100 table-responsive">
                                <table class="table table-bordered table-hover table-sm">
                                    ...
                                    <tbody>
                                    <?php
                                    $devices = $pdo->query("SELECT * FROM `devices` where `type` = 'n_ws'");

                                    while($device = $devices->fetch(PDO::FETCH_ASSOC)):
                                        $dev_uni = $device['uni'];
                                        ?>

                                        <tr class="pointer" data-toggle="modal" data-target="#device2details">
                                            <td>SN/<?php echo $device['branch'] . "/".$device['id'] ?></td>
                                            <td><?php echo $device['cpu'] ?></td>
                                            <td><?php echo $device['branch'] ?></td>
                                            <td><?php echo $device['department'] ?></td>
                                            <td><?php echo $device['cpu_model'] ?></td>
                                            <td><?php echo $device['cpu_serial'] ?></td>
                                        </tr>
                                        <div class="modal" id="device2details">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="w-100 d-flex flex-wrap p-1">
                                                            <button class="btn btn-sm btn-info m-1">PDF</button>
                                                        </div>
                                                        <p>
                                                            <?php echo $device['details'] ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <?php }
            elseif ($view === 'edit') { $dev = $_SESSION['device']; ?>
