                    ...
                    <div class="table-responsive h-100 p-3 o-auto">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <?php while($user = $user_stmt->fetch(PDO::FETCH_ASSOC)):
                                    ...
                                    <td>
                                        <div class="dropdown dropleft">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item text-warning" data-toggle="modal" data-target="#app_<?php echo $u_id ?>grp">Assign App</a>
                                ...
                                <form method="post" action="config/proc/form/usermgmt.php" >
                                    <input type="hidden" name="token" value="<?php echo session_id() ?>">
                                    <input type="hidden" name="function" value="assign_app">
                                    <input type="hidden" name="user" value="<?php echo $user['id'] ?>">
                                    <div class="modal" id="app_<?php echo $u_id ?>grp">
                                        <div class="modal-dialog modal-dialog-centered">

                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <div class="w-100 d-flex flex-wrap">
                                                        <div class="w-50"><p class="modal-title">Assign Apps to <?php echo $user['username'] ?></p></div>
                                                ...
                                                <div class="modal-body" style="height: 70vh; overflow: auto">
                                                    <?php
                                                    $apps = $pdo->query("SELECT * FROM `appstore` where `type` != 'nav'");
                                                    while($app = $apps->fetch(PDO::FETCH_ASSOC)):
                                                        ?>
                                                        <div class="w-100 d-flex flex-wrap cust_shadow p-2">
                                                            <div class="w-20">
                                                                <input name="app_uni[]" type="checkbox" value="<?php echo $app['uni'] ?>">
                                                            </div>
                                                            <div class="w-80">
                                                                <h5><?php echo $app['name'] ?></h5>
                                                                <p class="text_eclips m-0">
