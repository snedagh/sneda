            ...
            <div class="col-sm-2 text-light h-100 overflow-hidden bg-dark">
                ...
                <article class="p-1">
                    ...
                    <div id="inventory_collapse" class="collapse pl-4">
                        ...
                        <span onclick="set_session('tool=inventory,todo=view_none_workstation,view=all','<?php echo $token ?>')" class="r_child pointer"><span class="fa fa-desktop"></span> None Workstations</span>
